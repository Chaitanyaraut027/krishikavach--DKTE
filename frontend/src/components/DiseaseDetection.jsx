...
const CROPS = [
  ...
  { id: 'Radish', icon: Sprout, image: '/crops/radish.png', harvestImage: 'https://images.unsplash.com/photo-1601493700631-2b16ec4b4716?auto=format&fit=crop&q=80&w=300', color: 'from-pink-400 to-fuchsia-500', bgLight: 'from-pink-50 to-fuchsia-50', border: 'border-pink-300', shadow: 'shadow-pink-200', emoji: '🌱' },
  { id: 'Groundnut', icon: Sprout, image: '/crops/groundnut.png', harvestImage: 'https://images.unsplash.com/photo-1596726883204-629a8a7ca29b?auto=format&fit=crop&q=80&w=300', color: 'from-amber-600 to-orange-600', bgLight: 'from-amber-50 to-orange-50', border: 'border-amber-300', shadow: 'shadow-amber-200', emoji: '🥜' },
  { id: 'Cauliflower', icon: Sprout, image: '/crops/cauliflower.png', harvestImage: 'https://images.unsplash.com/photo-1510627489930-0c1b0ba0cc1c?auto=format&fit=crop&q=80&w=300', color: 'from-emerald-400 to-green-600', bgLight: 'from-emerald-50 to-green-50', border: 'border-emerald-300', shadow: 'shadow-emerald-200', emoji: '🥦' },
  ...
  { id: 'Grape', icon: Sprout, image: '/crops/grape.png', harvestImage: 'https://images.unsplash.com/photo-1533616688419-b7a585564566?auto=format&fit=crop&q=80&w=300', color: 'from-purple-400 to-purple-600', bgLight: 'from-purple-50 to-purple-50', border: 'border-purple-300', emoji: '🍇' },
  { id: 'Apple', icon: Sprout, image: '/crops/apple.png', harvestImage: 'https://images.unsplash.com/photo-1567306226416-28f0efdc88ce?auto=format&fit=crop&q=80&w=300', color: 'from-red-500 to-red-700', bgLight: 'from-red-50 to-red-50', border: 'border-red-400', emoji: '🍎' },
  ...
  { id: 'Pepper', icon: Sprout, image: '/crops/pepper.png', harvestImage: 'https://images.unsplash.com/photo-1566367576510-184cf434199f?auto=format&fit=crop&q=80&w=300', color: 'from-green-400 to-green-700', bgLight: 'from-green-50 to-green-50', border: 'border-green-300', emoji: '🫑' },
  { id: 'Strawberry', icon: Sprout, image: '/crops/strawberry.png', harvestImage: 'https://images.unsplash.com/photo-1543528176-61b2395143a4?auto=format&fit=crop&q=80&w=300', color: 'from-rose-400 to-rose-600', bgLight: 'from-rose-50 to-rose-50', border: 'border-rose-300', emoji: '🍓' },
  { id: 'Blueberry', icon: Sprout, image: '/crops/blueberry.png', harvestImage: 'https://images.unsplash.com/photo-1497534446932-c946bc77376c?auto=format&fit=crop&q=80&w=300', color: 'from-blue-600 to-indigo-700', bgLight: 'from-blue-50 to-indigo-50', border: 'border-blue-300', emoji: '🫐' },
  { id: 'Cherry', icon: Sprout, image: '/crops/cherry.png', harvestImage: 'https://images.unsplash.com/photo-1528821415494-06798a720dc2?auto=format&fit=crop&q=80&w=300', color: 'from-red-600 to-rose-700', bgLight: 'from-red-50 to-rose-50', border: 'border-red-300', emoji: '🍒' },
  { id: 'Peach', icon: Sprout, image: '/crops/peach.png', harvestImage: 'https://images.unsplash.com/photo-1595124253349-20fbd5d72023?auto=format&fit=crop&q=80&w=300', color: 'from-orange-300 to-peach-400', bgLight: 'from-orange-50 to-orange-50', border: 'border-orange-200', emoji: '🍑' },
  { id: 'Squash', icon: Sprout, image: '/crops/squash.png', harvestImage: 'https://images.unsplash.com/photo-1506867072417-82a33785481e?auto=format&fit=crop&q=80&w=300', color: 'from-yellow-600 to-orange-700', bgLight: 'from-yellow-50 to-orange-50', border: 'border-yellow-300', emoji: '🎃' },
  { id: 'Raspberry', icon: Sprout, image: '/crops/raspberry.png', harvestImage: 'https://images.unsplash.com/photo-1518635017498-87afc04923cd?auto=format&fit=crop&q=80&w=300', color: 'from-pink-500 to-rose-600', bgLight: 'from-pink-50 to-rose-50', border: 'border-pink-300', emoji: '🫐' },
  { id: 'Soybean', icon: Sprout, image: '/crops/soybean.png', harvestImage: 'https://images.unsplash.com/photo-1591850123512-329048de6841?auto=format&fit=crop&q=80&w=300', color: 'from-yellow-600 to-amber-700', bgLight: 'from-yellow-50 to-amber-50', border: 'border-yellow-400', emoji: '🫘' },
  { id: 'Other', icon: Search, image: '/crops/other.png', harvestImage: 'https://images.unsplash.com/photo-1500382017468-9049fee74a62?auto=format&fit=crop&q=80&w=300', color: 'from-gray-400 to-gray-600', bgLight: 'from-gray-50 to-gray-50', border: 'border-gray-300', emoji: '🔍' },
];
